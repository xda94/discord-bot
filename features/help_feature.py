...
HELP_TEXT = (
    ...
    "**/memory-show**\n"
    "Privately show saved facts, topic notes, and recent conversation for this server or DM.\n\n"
    "**/memory-forget**\n"
    ...
    "in `.env`. In memory-enabled channels, the same requester's facts, topics, and "
    "recent conversation supplement live chat history. One request per user at a time with "
